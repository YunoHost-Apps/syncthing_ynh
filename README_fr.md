...
**Version incluse :** 1.22.0~ynh1 *(:warning: Il s'agit de la branche `ci-auto-update-v1.22.0`. La [branche `master`](https://github.com/YunoHost-Apps/syncthing_ynh/tree/master) utilisée dans le catalogue est actuellement en 1.21.0\~ynh2.)*
