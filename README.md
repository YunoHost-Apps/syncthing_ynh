...
**Shipped version:** 1.22.0~ynh1 *(:warning: This is the `ci-auto-update-v1.22.0` branch. The [`master` branch](https://github.com/YunoHost-Apps/syncthing_ynh/tree/master) used in the catalog is currently on version 1.21.0\~ynh2.)*
